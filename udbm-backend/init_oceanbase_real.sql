-- UDBM OceanBase 数据库初始化脚本 (真正的OceanBase)
-- 统一数据库管理平台 - OceanBase社区版
...
-- 插入订单数据
INSERT INTO orders (order_number, user_id, total_amount, status, payment_status, shipping_address) VALUES
...
-- 插入库存变动记录
INSERT INTO inventory_movements (product_id, movement_type, quantity, reference_type, reference_id, notes, created_by) VALUES
